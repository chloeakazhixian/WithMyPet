...
<table class="bbs-table" table style="margin-left: auto; margin-right: auto;margin-bottom: 2.5%;margin-top: -5%;">
<tr id = "t1">
...
<c:forEach items="${listResult.list}" var="board">
	<TR noshade>
		...
		<c:when test="${board.board_idx eq '4'}"><TD>쇼핑후기</TD></c:when>
...
<br>
<br>
<div class="boardtitle" style="padding-bottom: 7%;">
