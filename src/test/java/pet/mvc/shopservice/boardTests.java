...
public class boardTests {
	...
	/*
	 * @Test public void testInsert() { Product product = new Product(-1, "������",
	 * "12000", "�ܿ￣ ������ ������ �ְ�", "#best", null, "g1.jpg", 1, 1);
	 * productMapper.insert(product); log.info("#productTests insert() ���� �Ϸ�"); }
	 */
	  
	/*
	 * @Test public void testDelete() { long seq = 11L; addressMapper.delete(seq);
	 * log.info("#AddressTests delete() ���� �Ϸ�"); }
	 */
	}